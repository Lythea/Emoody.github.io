...
$conn = new mysqli($servername, $username, $password,$db,$port);
  ...
  $sql = "SELECT id,Year,Month,Day,email,date FROM dailylogin WHERE id= '$id' and Year = '$year' and Month = '$month' and Day ='$day' and date = '$date' and companyname ='$companyname'";
